...
import bannerImage from '../../../assets/person1.png';
        ...
        <div
            ...
            <div className='top-banner '>
                ...
                <div className='mt-8 grid grid-cols-2 mr-8'>
                    <button className='py-4  mr-4 bg-white text-primary  hover:bg-sky-600 hover:text-white'>LEARN MORE</button>
                    <button className='py-4 bg-secondary hover:bg-white hover:text-secondary'>AVAILABLE COUNTRIES <FontAwesomeIcon className='ml-1' icon={faArrowRight}></FontAwesomeIcon></button>
                </div>
            </div>
            <div className='banner-img-container'>
                <img className='banner-img h-full ' src={bannerImage} alt="" />
            </div>
            <div className='conversation1 '>
                <div className=' flex'>
                    <img className='w-14 py-3 mr-3' src={person2} alt="" />
            ...
            <div className='conversation2 '>
                <div className=' flex items-center '>
                    ...
                    <div className='w-14 h-14 ml-2 my-3 bg-primary rounded-full'>
                        <img className='w-14 ' src={person3} alt="" />
                    </div>
